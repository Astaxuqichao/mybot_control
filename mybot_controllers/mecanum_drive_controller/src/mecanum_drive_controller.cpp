...
MecanumDriveController::MecanumDriveController()
    : open_loop_(false), command_struct_(), wheel_separation_(0.0),
      ...
      publish_cmd_(false), publish_wheel_joint_controller_state_(false) {}
...
bool MecanumDriveController::init(
  ...
  for (size_t i = 0; i < wheel_joints_size_; ++i) {
    ...
    left_wheel_joints_[i] =
        hw->getHandle(left_wheel_names[i]); // throws on failure
    right_wheel_joints_[i] =
        hw->getHandle(right_wheel_names[i]); // throws on failure
  }
  ...
  dynamic_params.left_front_wheel_radius_multiplier =
      left_front_wheel_radius_multiplier_;
  dynamic_params.right_front_wheel_radius_multiplier =
      right_front_wheel_radius_multiplier_;
  dynamic_params.left_rear_wheel_radius_multiplier =
      left_rear_wheel_radius_multiplier_;
  dynamic_params.right_rear_wheel_radius_multiplier =
      right_rear_wheel_radius_multiplier_;

  dynamic_params.wheel_separation_multiplier = wheel_separation_multiplier_;
  dynamic_params.wheel_distance_multiplier = wheel_distance_multiplier_;
  ...
  MecanumDriveControllerConfig config;
  config.left_front_wheel_radius_multiplier =
      left_front_wheel_radius_multiplier_;
  config.right_front_wheel_radius_multiplier =
      right_front_wheel_radius_multiplier_;
  config.left_rear_wheel_radius_multiplier = left_rear_wheel_radius_multiplier_;
  config.right_rear_wheel_radius_multiplier =
      right_rear_wheel_radius_multiplier_;
  config.wheel_separation_multiplier = wheel_separation_multiplier_;
  config.wheel_distance_multiplier = wheel_distance_multiplier_;
  ...
  dyn_reconf_server_ = std::make_shared<ReconfigureServer>(
      dyn_reconf_server_mutex_, controller_nh);
  ...
  dyn_reconf_server_->setCallback(
      boost::bind(&MecanumDriveController::reconfCallback, this, _1, _2));
...
void MecanumDriveController::update(const ros::Time &time,
  ...
  if (open_loop_) {
    ...
    const double rfp = left_wheel_joints_[0].getPosition();
...
void MecanumDriveController::reconfCallback(
    MecanumDriveControllerConfig &config, uint32_t /*level*/) {
  DynamicParams dynamic_params;
  dynamic_params.left_front_wheel_radius_multiplier =
      config.left_front_wheel_radius_multiplier;
  dynamic_params.right_front_wheel_radius_multiplier =
      config.right_front_wheel_radius_multiplier;
  dynamic_params.left_rear_wheel_radius_multiplier =
      config.left_rear_wheel_radius_multiplier;
  dynamic_params.right_rear_wheel_radius_multiplier =
      config.right_rear_wheel_radius_multiplier;
  dynamic_params.wheel_separation_multiplier =
      config.wheel_separation_multiplier;
...
void MecanumDriveController::updateDynamicParams() {
  ...
  wheel_distance_multiplier_ = dynamic_params.wheel_distance_multiplier;
