#ifndef MYBOT_CONTROL__MECANUM_HARDWARE_INTERFACE_REAL_H
#define MYBOT_CONTROL__MECANUM_HARDWARE_INTERFACE_REAL_H
...
class MecanumBOTHardwareInterface : public mybot_hw::mybotHardware {
public:
  /// \brief Constructor.
  ///
  /// \param nh  Node handle for topics.
  MecanumBOTHardwareInterface(ros::NodeHandle &nh);

  /// \brief Destructor.
  ~MecanumBOTHardwareInterface();
